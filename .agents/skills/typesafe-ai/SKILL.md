---
name: typesafe-ai
description: Build AI-powered software with TypeSafe and Jev System One models. Converts natural language and state into typed judgments and probabilities (Choice, Score, Noul) for routing, classification, extraction, and verification. Use when designing fast decision layers, agent handoffs, or structured if-else AI logic.
